from revente_avec_maison import *
...
def test_revente1(monkeypatch):
    ...
    'maison':{'Ecsit':2, 'Guilde':0, 'PICS':0, 'Hyris':0, 'ViaRezo':0, 'Commus':0, 'Musics':0, 'BDA':0, 'NCV':0, 'Raid':0, 'BDS':0, 'SBCS':0, 'ADR':0, 'BDE':0, 'Oser':0, 'CheerUp':0, 'Huma':0, 'PAPS':0, 'FIR':0, 'Impact':0, 'JE':0, 'LeForum':0},
    ...
    revendre_bis(500,1,2,monopoly,joueurs)
    assert listes_proprietes(1,monopoly,joueurs) == []
